...
{ ServiceHan serhan;
  ...
  public int service_Two_LifeLight_Old=0;
...
//	Log.v("onCreate","onCreate"); 
  ...
  {value.constant.contentResolver=getApplicationContext().getContentResolver();
   method.makeDbAndTable(getApplicationContext());
...
public class ServiceHan extends Handler
	{@Override 
		public void handleMessage(Message msg)
	     {if(value.constant.service_One_LifeLight<10001)
		   {value.constant.service_One_LifeLight++;}
	     else{value.constant.service_One_LifeLight=0;}
	      if(!(service_Two_LifeLight_Old==value.constant.service_Two_LifeLight))
		  {service_Two_LifeLight_Old=value.constant.service_Two_LifeLight;}
	      else
	      {///if it dosest change ,means it is dead
	    	  MainService_Two mainService_Two=new MainService_Two();
	    	  Intent intent=new Intent(getApplicationContext(),com.example.doit.MainService_Two.class);
...
public class helpServiceTwo extends Thread
{public void run()
 {
